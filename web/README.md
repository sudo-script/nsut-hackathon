...
4. **Pitch deck** — 10 slides in plain language: pain, existing kits, our layer, a 2-axis comparison graph, TRL (Active Inference already built), TAM/SAM/SOM, GTM, seed ask. Arrow keys or **Print / PDF**.
