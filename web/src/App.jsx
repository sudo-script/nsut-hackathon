    ...
    <>
      ...
      <main className="layout">
        <aside className="panel controls">
          ...
          <p className="hint">
            Runs entirely in the browser from precomputed detector traces. Stealth snaps to the nearest baked value
            ({STEALTH_HINT}). Thresholds re-score alerts live.
          </p>
        </aside>
        ...
        <aside className="panel detectors">
          <div className="detector xgb">
            <h2>XGBoost</h2>
            <p className="meter-label">P(malicious | event)</p>
            <div className="meter">
            ...
            <p className="when">
              {campaign.race.mlDetectAt == null || index < 0
                ? "No alert yet"
                : `Alerted at event ${campaign.race.mlDetectAt}`}
            </p>
          </div>
          <div className="detector ns">
            <h2>Neuro-symbolic</h2>
            <p className="meter-label">Hidden-state belief</p>
            ...
            <p className="when">
              {campaign.race.nsDetectAt == null || index < 0
                ? "No alert yet"
                : `Alerted at event ${campaign.race.nsDetectAt}`}
            </p>
...
const STEALTH_HINT = "0 / 20 / 35 / 50 / 70 / 90";
